                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  //               final kamarList =
                                  //                   await ItemKamarController.getKamarByType(
                                  //                     widget.campId,
                                  ...
                                  //                 const SnackBar(
                                  //                   content: Text(
                                  //                     'Semua kamar berhasil di-upgrade ke VIP',
                                  //                   ),
                                  //                 ),
                                  //               );
                                  //             } catch (e) {
                                  ...
                                  itemBuilder: (context, index) {
                                    return ListTile(
                                      ...
                                      title: Text(
                                        isVipUpgraded
                                            ? 'VIP'
                                            : kamarTypes[index], // TAMPILAN SAJA YANG DIUBAH
                                        style: const TextStyle(
                                          fontSize: 16,
                                          fontWeight: FontWeight.bold,
                                          color: Colors.black,
                                      ...
                                      onTap: () {
                                        Navigator.pushNamed(
                                          ...
                                          arguments: {
                                            ...
                                            'type':
                                                kamarTypes[index], // Tetap kirim type ASLI!
                                            'vip_override':
                                                isVipUpgraded, // <-- tambahkan flag ini
                                          },
                                        );
                                      },
                                    );
